...
"""
 test different values for learning rate (alpha), discount factor (gamma), and exploration rate decay (epsilon_decay). 
 I'll modify the script to loop over different values, train a Q-learning agent for each combination, and track performance
"""
"""I've implemented grid search for hyperparameter tuning in your Q-learning script. 
Now, it tests multiple values of alpha, gamma, and epsilon_decay, tracking the best-performing combination based on average rewards. """
"""
